<?php 
	...
	if(isset($_POST['addcategory']))
	{
		...
		$path = "../kategori/".$namakategori.'.'.$ext;
		$pathdb = "kategori/".$namakategori.'.'.$ext;
		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
              ...
              $sql = mysqli_query($conn,"insert into kategori (file, namakategori) values ('$pathdb','$namakategori')");
			  
			  if($sql){ 
				
				echo "<br><meta http-equiv='refresh' content='5; URL=kategori.php'> You will be redirected to the form in 5 seconds";
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><a href="delete.php?id=<?= $p['idkategori'] ?>&section=kategori" class="btn btn-danger">Hapus</a></td>
