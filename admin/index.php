                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <?php
                                        while($kontakr = mysqli_fetch_assoc($kontak)){
                                    ?>
                                    <div style="border: 1px solid gray; padding: 10px; border-radius: 5px; margin-bottom: 10px;">
                                        <strong><?= $kontakr['email'] ?></strong> <span style="float: right"><?= $kontakr['tgl'] ?></span>
                                        <br>
                                        <p><?= $kontakr['text'] ?></p>
                                    </div>
                                    <?php
